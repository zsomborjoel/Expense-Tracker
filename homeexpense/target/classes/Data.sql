insert into user values (1, 'Zsombor', 'zsomborjoel@gmail.com');
insert into user values (2, 'John', 'John@john.com');
insert into user values (3, 'Adam', 'adam@adam.com');

insert into category values (1, 'Travel', 1);
insert into category values (2, 'Auto Loan', 2);
insert into category  values (3, 'Travel', 1);
